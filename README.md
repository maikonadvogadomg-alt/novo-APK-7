# @workspace/apk-builder — App Desktop
...
- `-workspace-apk-builder-Setup-3.0.0.exe` → Windows
- `-workspace-apk-builder-3.0.0.AppImage` → Linux
- `-workspace-apk-builder-3.0.0.dmg` → Mac
...
- **Linux**: Execute `chmod +x -workspace-apk-builder*.AppImage` antes de rodar.
